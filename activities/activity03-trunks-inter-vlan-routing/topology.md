...
1 x Multilayer Switch 3560-24PS (D1), 2 x Switch 2960 (S1,S2), 2 x PC-PT (PC1,PC2)
...
# Activity 03 topology and evidence contract

Scenario: Diagnose a missing allowed VLAN and native VLAN mismatch, then verify SVI gateway mapping.
