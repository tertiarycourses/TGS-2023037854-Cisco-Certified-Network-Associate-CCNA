...
1 x Multilayer Switch3560-24PS (D1), 2 x Switch2960 (S1,S2), 1 x PC-PT (PC1), 1 x Server-PT (APP), 1 x PC-PT (MGMT)
...
# Activity 12 topology and evidence contract

Scenario: Use time-correlated service evidence to isolate a trunk fault and verify a narrow change with regression tests and rollback.
