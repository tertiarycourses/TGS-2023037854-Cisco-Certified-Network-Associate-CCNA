...
2 x Router 2911 (R1,R2), 2 x Switch 2960 (S1,S2), 2 x PC-PT (PC1,PC2)
...
# Activity 01 topology and evidence contract

Scenario: Allocate non-overlapping VLSM subnets and explain remote packet versus next-hop frame addressing.
