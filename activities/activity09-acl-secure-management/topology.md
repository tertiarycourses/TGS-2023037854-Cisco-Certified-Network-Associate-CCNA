...
2 x Router2911 (R1,R2), 2 x Switch2960 (S1,S2), 2 x PC-PT (PC1,PC2)
...
# Activity 09 topology and evidence contract

Scenario: Evaluate ordered ACL rules and secure VTY access, including AAA client/server roles and safe fallback.
