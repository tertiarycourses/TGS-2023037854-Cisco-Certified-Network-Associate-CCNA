...
3 x Router2911 (R1,R2,R3), 2 x Switch2960 (S1,S2), 2 x PC-PT (PC1,PC2)
...
# Activity 07 topology and evidence contract

Scenario: Diagnose OSPF adjacency, path costs and a virtual gateway; distinguish current v1.1 FHRP explanation from refresh practice.
