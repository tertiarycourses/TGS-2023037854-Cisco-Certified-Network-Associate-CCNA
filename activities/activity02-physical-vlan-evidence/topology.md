...
1 x Router 2911 (R1), 1 x Switch 2960 (S1), 2 x PC-PT (PC1,PC2)
...
# Activity 02 topology and evidence contract

Scenario: Use interface counter deltas and endpoint VLAN membership to separate physical faults from segmentation errors.
